 ...
 */
export const checkDateOfBirth = (userDobStr, examData, examSession = null, examCode = null) => {
    ...
    switch (criteriaType) {
        ...
        case 'BETWEEN_AGE': {
            ...
            if (!betweenAgeValue && examData.between_dob) {
                const betweenDobValue = getValueForSession(examData.between_dob, examSession, examCode);
